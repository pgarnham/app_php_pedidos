...
require("connection.php");
  ...
  $query_3 = "SELECT * FROM categorias WHERE categorias.cat_id = $id_category";
  $result_3 = $my_db -> prepare($query_3);
  $result_3 -> execute();
  $categoria = $result_3 -> fetchAll();
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" class="register-form" id="login-form" action="consultas/edit_category_consulta.php">
                            <div class="form-group">
                                ...
                                <?php
                                echo "<input type='text' value='$categoria[1]' name='nombre' id='nombre'/>";
                                ?>
                            </div>
                            
                            <input type="hidden" name="category_id" value="<?php echo $categoria[0]; ?>">
